...
ccw_spiral0 = [42,35,28,21,14,7,0]
ccw_spiral1 = [43,36,29,22,15,8,1]
ccw_spiral2 = [44,37,30,23,16,9,2]
ccw_spiral3 = [45,38,31,24,17,10,3]
ccw_spiral4 = [46,39,32,25,18,11,4]
ccw_spiral5 = [47,40,33,26,19,12,5]
ccw_spiral6 = [48,41,34,27,20,13,6]

--clockwise out from the center
cw_spiral0 = [43,37,31,25,19,13,0]
cw_spiral1 = [44,38,32,26,20,7,1]
cw_spiral2 = [45,39,33,27,14,8,2]
cw_spiral3 = [46,40,34,21,15,9,3]
cw_spiral4 = [47,41,28,22,16,10,4]
cw_spiral5 = [48,35,29,23,17,11,5]
cw_spiral6 = [42,36,30,24,18,12,6]
